      ...
      >
        ...
        <div className="glass-card rounded-3xl p-8">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            >
              {loading ? <Loader2 className="w-5 h-5 animate-spin" /> : <>Ingresar <ArrowRight className="w-5 h-5" /></>}
            </button>
          </form>
          ...
          <div className="mt-8 text-center space-y-4">
            <p className="text-slate-400 text-sm">
              ...
              <Link href="/teacher/register" className="text-indigo-400 font-semibold hover:underline">
                Regístrate aquí
              </Link>
            </p>
            <button 
